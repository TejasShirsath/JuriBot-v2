...
export const SocialLogin: React.FC = () => {
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="w-full bg-white border border-charcoal/10 py-3 rounded-lg flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors cursor-pointer"
      >
        <GoogleIcon />
